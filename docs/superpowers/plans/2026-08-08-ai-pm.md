...
- [ ] **Step 4: 创建完整示例内容（先建 A1 卡片与题库）**

注意：知识卡文件名 = 能力项 id（如 `A1.md`），与计划生成器 `day_tasks` 的 `content_ref = "knowledge_cards/{capability_id}.md"` 保持一致。

`data/content/knowledge_cards/A1.md`：
